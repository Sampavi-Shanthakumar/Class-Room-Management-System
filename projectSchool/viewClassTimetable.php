...
$query = "SELECT * FROM timetable t , class_details cd , class c , division d, subject s where cd.teacher_id = '$tid' and cd.class_id = t.class_id and cd.division_id = t.division_id and t.class_id = c.class_id and t.division_id = d.division_id and cd.subject_code = s.subject_code";
