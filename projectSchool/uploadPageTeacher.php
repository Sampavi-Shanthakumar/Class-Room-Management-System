...
<div class="panel-body"style="height:auto" >
   <div class="container">
		<div class="row">
<div class="col-6">
    <form class="form-signin" method="POST" enctype="multipart/form-data" action="uploadTeacher.php">
      ...
      ?>
        ...
        $result1 = $db->query($query1);
        		...
        		<select class="form-control" id="division" name="Subject" style="width:200px">
