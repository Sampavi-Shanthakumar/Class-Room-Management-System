...
<form method="post" action="sendResetLink.php"  class="form-signin" autocomplete="off">
...
<center><input name="reset" type="submit" value="Submit" class="btn btn-link" style="text-decoration:none; background-color:green; color:white;"></center>
