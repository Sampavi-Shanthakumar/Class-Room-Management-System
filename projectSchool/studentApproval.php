...
<div class="content">
     ...
     <table class="table table-bordered">
   	...
   	$sql="SELECT * from login l inner join student s inner join class c inner join division d  on l.user_id=s.user_id and s.class_id=c.class_id and s.division_id = d.division_id";
