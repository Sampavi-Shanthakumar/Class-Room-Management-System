...
<div class="panel-body">
		 ...
		 <form method="post" action="AddPrincipalCode.php" autocomplete="off">
		<center><h5 class="heading" style="font-size:30px;font-family:lato;">Principal Profile</h5></center><hr>
		<div class="container">
		<div class="row">
		<div class="col-6">
		 ...
		 <div class="form-group"><label>Principal Id: </label><br/>
		 <input name="Principalid" placeholder="principal id" type="text" class="form-control" pattern="[A-Za-z0-9]{4}" required></div>
	     <div class="form-group"><label>First Name: </label><br/>
		 <input name="Firstname" placeholder="first name" type="text" id="txtNumeric1" class="form-control" required></div>
		 <script>
	 	$(function() {
	 $('#txtNumeric1').keydown(function (e) {
		 ...
		 <input name="Lastname" placeholder="last name" type="text" id="txtNumeric2" class="form-control" required></div>
		 <script>
	 	$(function() {
	 $('#txtNumeric2').keydown(function (e) {
		 ...
		 <input name="Street" placeholder="street" type="text" id="txtNumeric3" class="form-control" required></div>
		 <script>
	 	$(function() {
	 $('#txtNumeric3').keydown(function (e) {
		 ...
		 <input name="City" placeholder="city" type="text" id="txtNumeric4" class="form-control" required></div>
		 <script>
	 	$(function() {
	 $('#txtNumeric4').keydown(function (e) {
		 ...
		 <input name="Phoneno" placeholder="phone no" type="tel" class="form-control" maxlength="10" pattern="\d{10}" title="Please enter exactly 10 digits" required></div>
		 <div class="form-group"><label>Email: </label> <br/>
		 <input name="Email" type="email" placeholder="email" required class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"></div>
		 </fieldset>
		</div>
		</div>
		</div>
		 <input type="submit" value="Add Principal Details" name="reg_principal" id="btn" class="btn btn-success" style="margin-left:900px;" >
		 </form>
		 </div>
		</div>
		</div>
