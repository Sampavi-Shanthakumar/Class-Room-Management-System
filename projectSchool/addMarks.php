...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
    ...
    var division = $('#division').val();
     ...
     $.ajax({
               url : "viewStudent.php",
               method:"POST",
               data:{action:action, subject:subject, userid:userid ,grade:grade, division:division},
...
<body>
  ...
  <center><h1 class="heading" style="font-size:30px;font-family:lato;">ADD MARKS</h1></center>
  <div class="row">
  <div class="col-6">
...
$query2 = "SELECT * from subject s, class_details cd where cd.teacher_id = '$tid' and cd.subject_code = s.subject_code group by cd.subject_code";
...
<div>
	<section class="">
      <form action="addMarksCode.php" method="post" autocomplete="off">
